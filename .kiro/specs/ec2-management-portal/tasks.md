...
- [ ] 1. Extend config and add portal constants
  - [ ] 1.1 Add portal constants to `internal/config/constants.go`
  ...
  - [ ] 1.2 Extend `internal/config/config.go` with portal fields and loading logic
  ...
  - [ ]* 1.3 Write property tests for config loading
  ...
  - [ ]* 1.4 Write unit tests for config edge cases
...
- [ ] 2. Create `internal/portal` package skeleton
  - [ ] 2.1 Create `internal/portal/handler.go` — Handler struct and constructor
  ...
  - [ ] 2.2 Create `internal/portal/ec2.go` — AWS client interfaces and view models
  ...
  - [ ] 2.3 Create `internal/portal/session.go` — PortalSession and OAuthState types and helpers
  ...
  - [ ]* 2.4 Write property tests for session validity
  ...
  - [ ]* 2.5 Write unit tests for session helpers
...
- [ ] 3. Checkpoint — ensure `task build` passes with package skeleton
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Create `internal/portal/oidc.go` — OIDC client and PKCE helpers
  - [ ] 4.1 Implement PKCE pure-function helpers
  ...
  - [ ] 4.2 Implement `OIDCClient` struct, `jwksCache`, and token types
  ...
  - [ ] 4.3 Implement `OIDCClient` methods
  ...
  - [ ]* 4.4 Write property tests for PKCE and token validation
  ...
  - [ ]* 4.5 Write unit tests for OIDCClient
...
- [ ] 5. Create `cmd/web/pages/portal_error.templ` — OAuth error page
  - [ ] 5.1 Implement `PortalError(props ErrorPageProps)` component
  ...
  - [ ]* 5.2 Write unit tests for error page rendering
    - Test: renders status code and message in output
    - Test: "Try again" link has `href="/login"`
    - _Requirements: 2.5_

- [ ] 6. Implement auth handlers and middleware
  - [ ] 6.1 Create `internal/portal/auth.go` — OAuth handlers and auth middleware
  ...
  - [ ]* 6.2 Write property tests for auth middleware and callback handler
  ...
  - [ ]* 6.3 Write unit tests for auth edge cases
...
- [ ] 7. Checkpoint — ensure `task build` and `task test` pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 8. Create management dashboard Templ components
  - [ ] 8.1 Create `cmd/web/pages/portal_mgmt.templ` — management dashboard page
  ...
  - [ ] 8.2 Create `cmd/web/partials/portal_fragments.templ` — HTMX fragment components
  ...
  - [ ]* 8.3 Write property tests for Templ component rendering
  ...
  - [ ]* 8.4 Write unit tests for fragment rendering
...
- [ ] 9. Checkpoint — run `task generate` then `task build` and `task test`
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 10. Implement management handlers
  - [ ] 10.1 Create `internal/portal/mgmt.go` — dashboard and instance action handlers
  ...
  - [ ]* 10.2 Write property tests for instance action handlers
  ...
  - [ ]* 10.3 Write unit tests for management handler edge cases
  ...
  - [ ] 10.4 Create `internal/portal/metrics.go` — metrics and logs handlers
  ...
  - [ ]* 10.5 Write unit tests for metrics and logs handlers
...
- [ ] 11. Create `internal/portal/page.go` — rendering helpers
  - [ ] 11.1 Implement `renderErrorPage`, `renderDashboard`, `renderFragment` thin wrappers
...
- [ ] 12. Wire portal into `internal/app`
  - [ ] 12.1 Extend `internal/app/app.go` — add `PortalHandler` field and AWS client construction
  ...
  - [ ] 12.2 Register portal routes in `internal/app/server.go`
...
- [ ] 13. Add `.env.example` entries for portal env vars
  - [ ] 13.1 Append portal env var entries to `.env.example`
...
- [ ] 14. Final checkpoint — full CI pass
