...
func TestBuildCareerStagesIgnoresInputOrderAndSide(t *testing.T) {
	...
	for index := range shuffled {
		if index%2 == 0 {
			shuffled[index].Side = "right"
		} else {
			shuffled[index].Side = "left"
		}
	}
...
func TestBuildCareerStagesUsesCanonicalYearBoundariesWithoutLoss(t *testing.T) {
	experiences := []types.Experience{
		{ID: 4, Duration: "2021 – Present", Side: "left"},
		{ID: 2, Duration: "2017 – 2018", Side: "left"},
		{ID: 1, Duration: "2016 – 2017", Side: "right"},
		{ID: 3, Duration: "2020 – 2021", Side: "right"},
	}
...
func task5CareerFixture() []types.Experience {
	return []types.Experience{
		{ID: 1, Position: "Cloud Engineer Principal", Company: "COMPANY REDACTED - A", Duration: "2022 – Present", Technologies: []string{"AWS", "Go", "Terraform", "Ansible"}, Side: "left"},
		{ID: 2, Position: "System Administrator", Company: "COMPANY REDACTED - B", Duration: "2021 – 2022", Technologies: []string{"IoT", "SCADA", "RHEL", "Bash"}, Side: "right"},
		{ID: 3, Position: "IT Systems Engineer Sr", Company: "COMPANY REDACTED - C", Duration: "2020 – 2021", Technologies: []string{"Azure", "AD DS", "PowerShell"}, Side: "left"},
		{ID: 4, Position: "IT Systems Engineer", Company: "COMPANY REDACTED - C", Duration: "2018 – 2020", Technologies: []string{"PowerShell", "AD DS", "O365/Exchange"}, Side: "right"},
		{ID: 5, Position: "IT Desktop Engineer", Company: "COMPANY REDACTED - C", Duration: "2017 – 2018", Technologies: []string{"PowerShell", "SCCM", "Intune"}, Side: "left"},
		{ID: 6, Position: "IT Service Desk Associate", Company: "COMPANY REDACTED - C", Duration: "2016 – 2017", Technologies: []string{"ServiceNow", "O365", "Windows"}, Side: "right"},
		{ID: 7, Position: "Service Desk Student Analyst", Company: "COMPANY REDACTED - D", Duration: "2012 – 2016", Technologies: []string{"Windows", "MacOS", "GoogleApps"}, Side: "left"},
	}
}
