...
func validateFinal10OrdinaryContract(graph final10Graph) error {
	...
	targets := []final10Target{
		...
		{label: "secondary action", aliases: []string{".page-kit-action", ".ui-action-secondary", ".portal-action-control", ".portal-control", "#skills-search-submit", ".skills-search-submit"}, types: []string{"button"}, guaranteed: []string{".page-kit-action", ".ui-action-secondary", ".portal-action-control", ".portal-control", "#skills-search-submit", ".skills-search-submit"}, excluded: []string{".page-kit-action-primary", ".ui-action-primary", ".ui-action-quiet", ".btn-primary"}, allowed: effects[3:5]},
